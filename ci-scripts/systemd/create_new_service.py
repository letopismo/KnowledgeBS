# https://github.com/albertz/mouse-scroll-wheel-acceleration-userspace/blob/main/install-daemon.py
#!/usr/bin/env python3
...
def setup(args):
  ...
  systemd_user_dir = Path(f'~/.config/systemd/user').expanduser()
...
def main():
  ...
  p.add_argument('--unit-name', type=str, default=f'{common.app_name}.service', help='Systemd unit name')
  args = p.parse_args()
  setup(args)
